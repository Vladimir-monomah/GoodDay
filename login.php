...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['email']) || empty($_POST['password'])) {
        $error_message = 'Электронная почта и / или пароль не могут быть пустыми<br>';
    } else {
        ...
        if($total==0) {
            $error_message .= 'Адрес электронной почты не совпадает<br>';
        } else {       
	...
	<div class="login-logo">
  	...
  	<div class="login-box-body">
		...
		<form action="" method="post">
			...
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Пароль" name="password" type="password" autocomplete="off" value="">
			</div>
			<div class="row">
				<div class="col-xs-8"></div>
				<div class="col-xs-4">
					<input type="submit" class="btn btn-primary btn-block btn-flat login-button" name="form1" value="Вход">
				</div>
			</div>
		</form>
	</div>
