...
<section class="content-header">
	<div class="content-header-left">
		<h1>Добавить меню (главное меню)</h1>
	</div>
	<div class="content-header-right">
		<a href="menu-main.php" class="btn btn-primary btn-sm">Посмотреть все</a>
	</div>
</section>
						...
						<form class="form-horizontal" action="" method="post">
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Родитель <span>*</span></label>
										<div class="col-sm-4">
											<select class="form-control select2" name="menu_parent" style="width:250px;">
												<option value="">Выберите родителя для этого меню</option>
