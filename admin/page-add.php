...
if(isset($_POST['form1'])) {
    ...
    if($path!='') {
    	...
    	$valid = 0;
        $error_message .= 'Вы должны выбрать фото для баннера<br>';
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Страница успешно добавлена.';
    }
}
?>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select class="form-control select2" name="page_layout" style="width:300px;" onchange="showContentInputArea(this)">
									<option value="Full Width Page Layout">Макет страницы во всю ширину</option>
									<option value="About Us Page Layout">О нас Макет страницы</option>
									<option value="Service Page Layout">Макет служебной страницы</option>
									<option value="FAQ Page Layout">Макет страницы FAQ</option>
									<option value="Chef Page Layout">Макет страницы шеф-повара</option>
									<option value="Menu Style 1 Page Layout">Стиль меню 1 Макет страницы</option>
									<option value="Menu Style 2 Page Layout">Стиль меню 2 Макет страницы</option>
									<option value="Menu Style 3 Page Layout">Стиль меню 3 Макет страницы</option>
									<option value="Menu Style 4 Page Layout">Стиль меню 4 Макет страницы</option>
									<option value="Photo Gallery Page Layout">Макет страницы фотогалереи</option>
									<option value="News Page Layout">Макет страницы новостей</option>
									<option value="Contact Us Page Layout">Свяжитесь с нами Макет страницы</option>
									<option value="Reserve Table Page Layout">Макет страницы резервной таблицы</option>
								</select>
							</div>
						</div>
