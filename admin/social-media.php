		...
		<div class="col-md-12">
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">						
						<p style="padding-bottom: 20px;">Если вы не хотите отображать социальные сети на своей главной странице, просто оставьте поле ввода пустым.</p>
