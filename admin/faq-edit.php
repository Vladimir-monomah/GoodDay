...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['faq_title'])) {
        $valid = 0;
        $error_message .= "Заголовок FAQ не может быть пустым<br>";
    }

    if(empty($_POST['faq_content'])) {
        $valid = 0;
        $error_message .= "FAQ Содержимое не может быть пустым<br>";
    }
    
    if(empty($_POST['faq_category_id'])) {
        $valid = 0;
        $error_message .= "Вы должны выбрать категорию FAQ<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'FAQ обновлен успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Редактировать FAQ</h1>
	</div>
	<div class="content-header-right">
		<a href="faq.php" class="btn btn-primary btn-sm">Посмотреть все</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Название FAQ <span>*</span></label>
							<div class="col-sm-9">
								<input type="text" class="form-control" name="faq_title" value="<?php echo $faq_title; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">FAQ Содержание <span>*</span></label>
							<div class="col-sm-9">
								<textarea class="form-control" name="faq_content" id="editor1"><?php echo $faq_content; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Выберите категорию FAQ <span>*</span></label>
							<div class="col-sm-4">
