...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['designation_name'])) {
        $valid = 0;
        $error_message .= "Обозначение Имя не может быть пустым<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Обозначение Имя уже существует<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Обозначение добавлено успешно.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Добавить обозначение</h1>
	</div>
	<div class="content-header-right">
		<a href="designation.php" class="btn btn-primary btn-sm">Посмотреть все</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Обозначение Имя <span>*</span></label>
							<div class="col-sm-4">
