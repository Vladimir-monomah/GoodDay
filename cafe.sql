...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 10 2021 г., 17:01
...
--
-- Структура таблицы `tbl_bron`
--

CREATE TABLE `tbl_bron` (
  `id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `tbl_bron`
--

INSERT INTO `tbl_bron` (`id`, `user_id`, `first_name`, `last_name`, `email`, `phone`, `date`, `time`, `message`) VALUES
(4, 18, 'sdv', 'sdv', 'dsf@dfdf.rdv', 111, 1617224400, '14:00', 'двымтдыатдауао');
...
(17, 'dfdgd', 'dfg@dfv.re', '111', '202cb962ac59075b964b07152d234b70', '', 'User', 'Active'),
(18, 'sdv', 'dsf@dfdf.rdv', '111', '202cb962ac59075b964b07152d234b70', '', 'User', 'Active'),
(20, 'Иванов Иван Иванович', 'ivan@mail.ru', '111', '202cb962ac59075b964b07152d234b70', '', 'User', 'Active');
...
--
-- Индексы таблицы `tbl_bron`
--
ALTER TABLE `tbl_bron`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_bron_user` (`user_id`);
...
--
-- AUTO_INCREMENT для таблицы `tbl_bron`
--
ALTER TABLE `tbl_bron`
...
--
-- Ограничения внешнего ключа таблицы `tbl_bron`
--
ALTER TABLE `tbl_bron`
  ADD CONSTRAINT `fk_bron_user` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`id`);
COMMIT;
